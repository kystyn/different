#ifndef IPLUGINPARTICLEFACTORYV2_1_0_H
#define IPLUGINPARTICLEFACTORYV2_1_0_H

/***************************************************************************/
/* This header file contains the V2.1.0 plugin factory API definition.     */
/*                                                                         */
...
/* create a new class derived from IPluginParticleFactoryV2_1_0 that       */
...
namespace NApiFactory
{
     ...
     * definition.
     */
    class IPluginParticleFactoryV2_1_0 : public IPluginParticleFactory
    {
    public:
        /**
         ...
         */
        virtual ~IPluginParticleFactoryV2_1_0() {}
         ...
         * @param simData
         *            Versioned interface providing access to the initial
         *            value for all simulation custom properties and a corresponding changeset.
         */
        virtual NApi::ECalculateResult createParticle(
                                           ...
                                           NApiCore::ICustomPropertyDataApi_1_0* simData) = 0;
         ...
         * The function is called from the processor's performAnalysis routine at
        ...
        /**
         * Returns the smallest scale of particle that the factory will create.
         * That figure is then used to calculate the rayleigh timestep and rmin
         * in the Simulator.
         *
         * @param scale (RETURN_VALUE) 
         *              The smallest scale of particle this factory could create.
         * @param type  (RETURN_VALUE)
         *              The type name of the smallest particle this factory could create.
         */
        virtual void getSmallestScale(double& scale, char type[NApi::API_BASIC_STRING_LENGTH]) const = 0;
    };
};

#endif // IPLUGINPARTICLEFACTORYV2_1_0_H
